...
const checkMultipleEpisodes = (previouslySelectedCheckbox, currentSelectedCheckBox) => {
    episodesInUi = document.querySelectorAll("input");
    let selectCheckboxFrom = Array.prototype.indexOf.call(episodesInUi, previouslySelectedCheckbox);
    let selectCheckboxTo = Array.prototype.indexOf.call(episodesInUi, currentSelectedCheckBox);

    if(selectCheckboxFrom > selectCheckboxTo)
    {
        [selectCheckboxFrom, selectCheckboxTo] = [selectCheckboxTo, selectCheckboxFrom];
    }
